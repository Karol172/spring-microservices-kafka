...
@AllArgsConstructor
@Slf4j
public class MulOperationGenerator implements OperationGenerator {
    ...
    public void generateOperation() {
        Operation operation = new Operation(random.nextGaussian(), random.nextGaussian(), OperationType.MULTIPLICATION);
