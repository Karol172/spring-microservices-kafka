...
@AllArgsConstructor
@Slf4j
public class SubOperationGenerator implements OperationGenerator {
    ...
    public void generateOperation() {
        Operation operation = new Operation(random.nextGaussian(), random.nextGaussian(), OperationType.SUBTRACTION);
